...
function SidebarProvider({
    ...
    const contextValue = React.useMemo<SidebarContextProps>(
        ...
        [state, open, setOpen, openMobile, setOpenMobile, toggleSidebar, sidebarWidth, isDragging, setIsDragging]
    )
...
function SidebarResizableHandle({side = "left"}: { side: "left" | "right" }) {
    const {state, setSidebarWidth, isDragging, setIsDragging} = useSidebar()
...
function Sidebar({
    ...
    const {state, isDragging} = useSidebar()
