use emmy_lsp_types::{CompletionItem, CompletionItemLabelDetails, InsertTextFormat, InsertTextMode};
use emmylua_parser::{LuaAstNode, LuaKind, LuaNameExpr, LuaSyntaxKind, LuaTokenKind};

use crate::handlers::completion::add_completions::check_match_word::check_match_word;
use crate::handlers::completion::completion_builder::CompletionBuilder;

use crate::handlers::completion::data::{KEYWORD_COMPLETIONS, KEYWORD_EXPR_COMPLETIONS};
...
fn add_function_keyword_completions(builder: &mut CompletionBuilder) -> Option<()> {
    ...
    let item = CompletionItem {
        ...
        kind: Some(emmy_lsp_types::CompletionItemKind::SNIPPET),
