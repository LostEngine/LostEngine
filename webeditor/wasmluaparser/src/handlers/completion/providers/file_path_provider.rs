...
use emmy_lsp_types::{CompletionItem, TextEdit};
...
fn add_file_path_completion(
    ...
    name: &str,
    prefix: &str,
    text_edit_range: emmy_lsp_types::Range,
) -> Option<()> {
    let kind: emmy_lsp_types::CompletionItemKind = if path.is_dir() {
        emmy_lsp_types::CompletionItemKind::FOLDER
    } else {
        emmy_lsp_types::CompletionItemKind::FILE
    };
    ...
    let completion_item = CompletionItem {
        ...
        text_edit: Some(emmy_lsp_types::CompletionTextEdit::Edit(text_edit)),
        detail,
        ..Default::default()
    };
