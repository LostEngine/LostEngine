use emmy_lsp_types::{CompletionItem, Position};
use emmylua_code_analysis::{
    check_export_visibility, EmmyrcFilenameConvention, LuaSemanticDeclId, LuaType, ModuleInfo,
};
use emmylua_parser::{LuaAstNode, LuaNameExpr};

use crate::util::module_name_convert::module_name_convert;
use crate::{
    handlers::{
...
fn add_module_completion_item(
    ...
    let completion_item = CompletionItem {
        ...
        kind: Some(emmy_lsp_types::CompletionItemKind::MODULE),
