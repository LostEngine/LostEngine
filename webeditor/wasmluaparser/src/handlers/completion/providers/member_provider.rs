use emmylua_code_analysis::{
    enum_variable_is_param, get_tpl_ref_extend_type, DbIndex, LuaMemberInfo, LuaMemberKey, LuaSemanticDeclId, LuaType,
    LuaTypeDeclId, SemanticModel,
};
use emmylua_parser::{LuaAstNode, LuaAstToken, LuaIndexExpr, LuaStringToken};
use std::collections::HashMap;

use crate::handlers::completion::add_completions::add_member_completion::add_member_completion;
use crate::handlers::completion::{
    add_completions::CompletionTriggerStatus,
